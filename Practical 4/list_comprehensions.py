...
for count in range(len(full_names)):
    lowercase_full_name = full_names[count].lower()
    lowercase_full_names.append(lowercase_full_name)
...
long_names = []
for count in range(len(full_names)):
    if len(full_names[count]) > 11:
        long_names.append(full_names[count])
for count in range(len(long_names)):
    print(long_names[count], end=", ")
